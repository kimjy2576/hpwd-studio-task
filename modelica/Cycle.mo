package HPWDcycle "L1 사이클 — volume 2개(고압/저압) + 컴포넌트 등압"
  ...
  model Cycle_L1_dyn
    ...
    HPWDhx.Cond_UA_eq cond(T_air_in_C=14.1,RH_in=0.7,V_air_CMM=2.62,UA_deSH=8.0,UA_2ph=50.0,UA_SC=5.0,R_fric=1e7);
    ...
    HPWDhx.Evap_UA_eq evap(T_air_in=20.0+273.15,RH_in=0.8,V_air_CMM=2.42,UA_2ph=25.0,UA_SH=4.0,R_fric=2e6);
  ...
  model Cycle_L1_ramp "L1 폐루프 — 정지 평형(균압·2상) 출발 + N ramp 기동"
    ...
    HPWDhx.Cond_UA_eq cond(T_air_in_C=14.1,RH_in=0.7,V_air_CMM=2.62,UA_deSH=8.0,UA_2ph=50.0,UA_SC=5.0,R_fric=1e7, m_dot(start=1e-5));
    ...
    HPWDhx.Evap_UA_eq evap(T_air_in=20.0+273.15,RH_in=0.8,V_air_CMM=2.42,UA_2ph=25.0,UA_SH=4.0,R_fric=2e6, m_dot(start=1e-5));
