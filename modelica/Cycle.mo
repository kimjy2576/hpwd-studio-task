package HPWDcycle "L1 사이클 — volume 2개(고압/저압) + 컴포넌트 등압"
  ...
  model Cycle_L1_dyn
    ...
    HPWDhx.Cond_UA_eq cond(T_air_in_C=14.47,RH_in=0.99,V_air_CMM=2.42,UA_deSH=15.5,UA_2ph=280.0,UA_SC=0.5,R_fric=1e7);
    ...
    HPWDhx.Evap_UA_eq evap(T_air_in=20.0+273.15,RH_in=0.8,V_air_CMM=2.42,UA_2ph=15.9,UA_SH=2.2,R_fric=2e6);
  ...
  model Cycle_L1_ramp "L1 폐루프 — 정지 평형(균압·2상) 출발 + N ramp 기동"
    ...
    HPWDhx.Cond_UA_eq cond(T_air_in_C=14.47,RH_in=0.99,V_air_CMM=2.42,UA_deSH=15.5,UA_2ph=280.0,UA_SC=0.5,R_fric=1e7, m_dot(start=1e-5));
    ...
    HPWDhx.Evap_UA_eq evap(T_air_in=20.0+273.15,RH_in=0.8,V_air_CMM=2.42,UA_2ph=15.9,UA_SH=2.2,R_fric=2e6, m_dot(start=1e-5));
