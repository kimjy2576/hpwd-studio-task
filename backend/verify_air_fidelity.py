...
MODELICA_REF = {
    'fan_L1': 727.091, 'fan_L2': 722.617,   # dp [Pa] @ 통일기하·정방향
    #   ↑ fan_L2는 스크롤 손실 추가 후 (이전 842.919 = 스크롤 누락)
...
def sweep_fan():
    ...
    print("     L2 오차 ±2% 이내 (스크롤 덤프손실 k=0.25 추가 후)")
    print("  ★ 스크롤 추가 전 L2는 +16~+19.5%로 L1보다 나빴음 — 지배 손실")
    print("    (스크롤=총손실 70%) 누락 탓. 추가로 fidelity 단조성 회복.")
