...
_overrides = {
    ...
    'fin_type': {'start': 'slit', 'description': 'Fin 타입 — 응축기 Slit'},
    'FPI': {'start': 22.0, 'description': '핀 밀도 (응축기 22 FPI)'},
    'N_rows': {'start': 6.0, 'description': '공기 흐름 row 수 (응축기 6)'},
    'D': {'start': 0.06, 'description': '공기 흐름 방향 두께 (코일 depth = N_row×P_l = 6×10mm)'},
